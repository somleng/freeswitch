...
getlibs () {
  ...
  getlib https://github.com/somleng/freeswitch/raw/build_debian/libs/sphinxbase-0.8.tar.gz
  getlib https://github.com/somleng/freeswitch/raw/build_debian/libs/pocketsphinx-0.8.tar.gz
  getlib https://github.com/somleng/freeswitch/raw/build_debian/libs/communicator_semi_6000_20080321.tar.gz
  #getlib https://download.zeromq.org/zeromq-2.1.9.tar.gz \
  #  || getlib https://download.zeromq.org/historic/zeromq-2.1.9.tar.gz
  getlib https://github.com/somleng/freeswitch/raw/build_debian/libs/freeradius-client-1.1.7.tar.gz
  #getlib https://files.freeswitch.org/downloads/libs/v8-3.24.14.tar.bz2
}
